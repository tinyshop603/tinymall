...
function needCLodop() {
  try {
    ...
    if (ua.match(/iPhone|iPod/i)) { return true }
...
export function getLodop(oOBJECT, oEMBED) {
  var strHtmInstall = "<br margin-left='50%' ><font style='margin-left:50%' color='#FF00FF'>打印控件未安装!点击这里<a href='install_lodop32.exe' target='_self'>执行安装</a>,安装后请刷新页面或重新进入。</font>"
  var strHtmUpdate = "<br> margin-left='50%' <font style='margin-left:50%' color='#FF00FF'>打印控件需要升级!点击这里<a href='install_lodop32.exe' target='_self'>执行升级</a>,升级后请重新进入。</font>"
  var strHtm64_Install = "<br margin-left='50%' ><font style='margin-left:50%' color='#FF00FF'>打印控件未安装!点击这里<a href='install_lodop64.exe' target='_self'>执行安装</a>,安装后请刷新页面或重新进入。</font>"
  var strHtm64_Update = "<br margin-left='50%' ><font style='margin-left:50%' color='#FF00FF'>打印控件需要升级!点击这里<a href='install_lodop64.exe' target='_self'>执行升级</a>,升级后请重新进入。</font>"
  var strHtmFireFox = "<br margin-left='50%' ><br><font style='margin-left:50%' color='#FF00FF'>（注意：如曾安装过Lodop旧版附件npActiveXPLugin,请在【工具】->【附加组件】->【扩展】中先卸它）</font>"
  var strHtmChrome = "<br margin-left='50%' ><br><font style='margin-left:50%' color='#FF00FF'>(如果此前正常，仅因浏览器升级或重安装而出问题，需重新执行以上安装）</font>"
  var strCLodopInstall_1 = "<br margin-left='50%' ><font style='margin-left:50%'  color='#FF00FF'>Web打印服务CLodop未安装启动，点击这里<a href='CLodop_Setup_for_Win32NT.exe' target='_self'>下载执行安装</a>"
  var strCLodopInstall_2 = "<br margin-left='50%' >（若此前已安装过，可<a href='CLodop.protocol:setup' target='_self'>点这里直接再次启动</a>）"
  var strCLodopInstall_3 = '，成功后请刷新本页面。</font>'
  var strCLodopUpdate = "<br margin-left='50%' ><font style='margin-left:50%' color='#FF00FF'>Web打印服务CLodop需升级!点击这里<a href='CLodop_Setup_for_Win32NT.exe' target='_self'>执行升级</a>,升级后请刷新页面。</font>"
  var LODOP
  try {
    var ua = navigator.userAgent
...
function fillPrinterData(LODOP, printData) {
  ...
  LODOP.ADD_PRINT_TEXT(topY += 10,  0, MAX_PAGE_WITH, SHOP_TITLE_HEIGTH, printData.shopName)
  ...
  for (let i = 0; i < printData.others.length; i++) {
    const other = printData.others[i]
    const sectionWith = MAX_PAGE_WITH
    marginLeft = 0
    topY += 15
