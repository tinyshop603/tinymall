...
import com.attitude.tinymall.HttpClientConnectionManager;
...
public class WxPayEngine {
  ...
  private String replace(boolean equals, String string, String string2) {
    return null;
  }
   ...
   * @return String
   */
  public String date2String(Date date, String formatType) {
   ...
   * 创建签名SHA1
   */
  public String createSHA1Sign(SortedMap<String, String> signParams) throws Exception {
   ...
   */
  public String postWithXmlParams(String url, String xmlParams) {
